  ...
  return (
    <div className="flex flex-col w-full h-full items-center justify-center">
      <div className="my-8 flex w-full justify-center">
        ...
        >
          {/* 자리 채우기 티켓 */}
          <div className="relative flex w-full h-[70vh] aspect-[75/135] min-w-70 min-h-120 max-w-100 max-h-180 invisible pointer-events-none items-center justify-center">
            <Ticket
